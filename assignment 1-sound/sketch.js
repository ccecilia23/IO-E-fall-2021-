...
function setup() {
  ...
  sound1 = loadSound('sounds/assets_sounds_clay.mp3');  
  sound2 = loadSound('sounds/BrianEno.mp3');  
  sound3 = loadSound('sounds/assets_sounds_wipe.mp3');  
...
function draw() {
  ...
  fill(138,217,255, 100);
  square(500, 150, diameter2*10);
