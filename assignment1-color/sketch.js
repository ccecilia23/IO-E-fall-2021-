...
function setup() {
  ...
  song = loadSound('assets_sounds_moon.mp3');
...
function draw() {
  ...
  ellipseMode(RADIUS);    
  fill(255, diameter1*5,196);
  noStroke(); 
  //console.log("diameter0  "  + diameter0);
  ellipse(500, 300, diameter0*200, diameter0*200);
    
  fill(diameter1,153,153, 130);
  square(500, 150, diameter1);
 
  fill(138,diameter1,diameter2*5, 100);
  triangle(diameter1+50, diameter2, diameter1, diameter2*30, diameter2*50, diameter1*2);
